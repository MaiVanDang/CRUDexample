...
public class SuppliersController {
	...
	// Edit Supplier
	@GetMapping("/edit")
	public String showEditPage(Model model, @RequestParam(value = "id", required = true) int id) {
	...
	@PostMapping("/edit")
	public String updateSupplier(Model model, @RequestParam(value = "id", required = true) int id,
			@Valid @ModelAttribute SupplierDto supplierDto, BindingResult result) {
		if (result.hasErrors()) {
			return "admin/suppliers/EditSupplier";
		}
	...
	@GetMapping("/delete")
	public String deleteSupplier(@RequestParam(value = "id", required = true) int id) {
