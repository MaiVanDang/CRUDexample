...
public class HomeController {
	...
	public String searchProducts(@RequestParam String category, @RequestParam float minPrice,
			@RequestParam float maxPrice, @RequestParam(required = false) String showTable, Model model) {
	...
	public String productView(@RequestParam(required = false) String showTable, Model model) {
		return "admin/products/index";
	}

	@GetMapping("/customerview")
	public String customerView(@RequestParam(required = false) String showTable, Model model) {
		return "admin/customers/index";
	}

	@GetMapping("/supplierview")
	public String supplierView(@RequestParam(required = false) String showTable, Model model) {
		return "admin/suppliers/index";
	}

	@GetMapping("/orderview")
	public String orderView(@RequestParam(required = false) String showTable, Model model) {
